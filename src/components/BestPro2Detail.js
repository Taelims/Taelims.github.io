...
function BestPro2Detail(props) {
  let [tab, tab변경] = useState(0);
  let [스위치, 스위치변경] = useState(false);

  let { id } = useParams();
  let selectPro = props.bestPro2.find(function (a) {
    return a.id == id;
  });
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-6">
          <img src={"/img/bestPro" + selectPro.id + ".jpg"} width="100%" />
        </div>
...
export default connect(함수명)(BestPro2Detail);
